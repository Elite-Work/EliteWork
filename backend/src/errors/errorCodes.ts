export enum ErrorCode {
  ...
  // Contract clawback error codes (Issue #97)
  // These mirror the on-chain panic message strings emitted by admin_clawback().
  CLAWBACK_UNAUTHORIZED = "CLAWBACK_UNAUTHORIZED",
  CLAWBACK_INSUFFICIENT_VESTED = "CLAWBACK_INSUFFICIENT_VESTED",
  ...
  // Admin submission failure classification
  SUBMISSION_VALIDATION_ERROR = "SUBMISSION_VALIDATION_ERROR",
  SUBMISSION_NETWORK_ERROR = "SUBMISSION_NETWORK_ERROR",
  SUBMISSION_CONTRACT_ERROR = "SUBMISSION_CONTRACT_ERROR",
  SUBMISSION_AUTHORIZATION_ERROR = "SUBMISSION_AUTHORIZATION_ERROR",
}
